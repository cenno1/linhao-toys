...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "Seasonal Squishy · Blind Box",
    tag: "Blind Box Ready",
    note: "Halloween Mystery blind box line — glitter-filled baozi squishies with 6 spooky-cute designs (pumpkin, ghost, eyeball & more). OEM: custom faces, glitter colors, blind box art and PDQ display. For seasonal retail, Amazon sellers and gift chains.",
    alt: "OEM Halloween shiny bao squishy blind box mystery wholesale China toy manufacturer LINHAO",
    keywords: [
      "custom squishy toy",
      "OEM toy manufacturer",
      "wholesale squishy toys",
